--los empleados con mas de 10 año aumenta su salario
...
insert into employees (employee_id,first_name,last_name,email,salary,hire_date,job_id,department_id) values (20,'test','test','qweweq',12,'12/12/12',12,60);
