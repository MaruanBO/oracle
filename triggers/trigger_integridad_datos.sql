...
BEGIN
    ...
    IF n >= 50 THEN
        raise_application_error(-20000,'Error de violacion a la integridad hacia la base de datos: El departamento 50 no puede disponer de mas de 50 empleados');
    END IF;
END;
/
...
insert into employees (employee_id,first_name,last_name,email,salary,hire_date,job_id,department_id) values (11,'test','test','ww',12,'12/12/12',12,60);
